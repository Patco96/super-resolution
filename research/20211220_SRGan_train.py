# %%
# https://github.com/sgrvinod/a-PyTorch-Tutorial-to-Super-Resolution/blob/master/train_srgan.py
import os
import time
import torch
...
train_folders = os.path.join(data_folder, "train/dog")
test_folders = os.path.join(data_folder, "val/dog")
